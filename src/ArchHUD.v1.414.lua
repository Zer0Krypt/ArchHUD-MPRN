...
-- User variables, visable via Edit Lua Parameters. Must be global to work with databank system as set up due to using _G assignment
    ...
    wpList = route --export:
    shorttestroute = {
        '::pos{0,2,23.8419,86.7354,216.5643}'
        ,'::pos{0,2,25.8522,87.3746,229.8824}'
        ,'::pos{0,2,90,0,1000000}' -- N Pole
        ,'::pos{0,2,22.9711,88.4444,170.0387}'
    }
    aliothpoles = {
        '::pos{0,2,90,0,1000000}'
        ,'::pos{0,2,0,90,1000000}'
        ,'::pos{0,2,0,180,1000000}'
        ,'::pos{0,2,0,0,1000000}'
        ,'::pos{0,2,0,-90,1000000}'
        ,'::pos{0,2,-90,0,1000000}'
        }
    ...
    marketcircle = {
        '::pos{0,2,36.0044,101.3503,220.0897}'
        ,'::pos{0,2,30.3314,101.3106,122.9764}'
        ,'::pos{0,2,28.3352,99.5187,165.9078}'
        ,'::pos{0,2,22.5024,98.1449,232.5154}'
        ,'::pos{0,2,21.2154,93.9616,251.0768}'
        ,'::pos{0,2,24.4469,88.0409,238.3019}'
        ,'::pos{0,2,28.7133,85.6389,260.7636}'
        ,'::pos{0,2,33.3939,87.3299,277.1366}'
        ,'::pos{0,2,34.9734,87.3012,176.2189}'
        ,'::pos{0,2,35.9865,91.8393,190.1616}'
        ,'::pos{0,2,22.9037,88.4599,218.3577}'
        }
